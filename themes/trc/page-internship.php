  ...
  <ul id="tab-nav">
    <div class="green-line">
      ...
      <li><a href="#">Overview</a>
        <section style="display:flex">
          ...
          <div class="overview-info">
            <h2>
              <?php echo wp_kses_post( CFS()->get( 'title_1' ) ); ?>
            </h2>
            <p>
              <?php echo wp_kses_post( CFS()->get( 'content_1' ) ); ?>
            </p>
          </div>
        </section>
      </li>
      ...
      <li><a href="#">Current Opportunities</a>
        <section>
          <h2>
            <?php echo wp_kses_post( CFS()->get( 'title_2' ) ); ?>
          </h2>
...
<div class="mobile-dropdown">
  ...
  <div id="content2" class="option2 content">
    ...
    <h2>
      <?php echo wp_kses_post( CFS()->get( 'title_2a' ) ); ?>
    </h2>
    <?php
            $args = array( 'post_type' => 'jobs', 'posts_per_page' => 3 );
            $loop = new WP_Query( $args );?>
