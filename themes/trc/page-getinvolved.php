        ...
        <div class = "overview-wrapper">
          ...
          <h2> Different ways to get involved with TRC</h2>
            <div class = "sponsor involvement">
              ...
              <a href="<?php get_template_directory_uri(); ?>/tekera/get-involved/sponsor" class="learn-more">Learn More</a>
            </div>
            ...
            <div class = "internship involvement">
              ...
              <a href="<?php get_template_directory_uri(); ?>/tekera/get-involved/internship" class="learn-more">Learn More</a>
            </div>
            ...
            <div class = "donate involvement">
              ...
              <a href="<?php get_template_directory_uri(); ?>/tekera/contact" class="learn-more">Learn More</a>
            </div>
        </div>
      </div>
