...
// Register Custom Post Type - SDG
function custom_post_type_sdgs() {
    $labels = array(
        'name'                  => 'SDGs',
        'singular_name'         => 'SDG',
        'menu_name'             => 'SDGs',
        'name_admin_bar'        => 'SDGs',
        'archives'              => 'SDG Archives',
        'attributes'            => 'SDG Attributes',
        'parent_item_colon'     => 'Parent SDG',
        'all_items'             => 'All SDGs',
        'add_new_item'          => 'Add New SDGs',
        'add_new'               => 'Add New',
        'new_item'              => 'New SDGs',
        'edit_item'             => 'Edit SDG',
        'update_item'           => 'Update SDG',
        'view_item'             => 'View SDG',
        'view_items'            => 'View SDGs',
        'search_items'          => 'Search SDGs',
        'not_found'             => 'Not found',
        'not_found_in_trash'    => 'Not found in Trash',
        'featured_image'        => 'Featured Image',
        'set_featured_image'    => 'Set featured image',
        'remove_featured_image' => 'Remove featured image',
        'use_featured_image'    => 'Use as featured image',
        'insert_into_item'      => 'Insert into SDG',
        'uploaded_to_this_item' => 'Uploaded to this SDG',
        'items_list'            => 'SDGs list',
        'items_list_navigation' => 'SDGs list navigation',
        'filter_items_list'     => 'Filter SDGs list',
    );
    $args = array(
        'label'                 => 'SDG',
        'description'           => 'SDGs',
    ...
    register_post_type( 'sdgs', $args );
}
add_action( 'init', 'custom_post_type_sdgs', 0 );

// Register Custom Post Type - Inverted SDG for mobile carousel
function custom_post_type_inverted_sdgs() {
    $labels = array(
        'name'                  => 'ISDGs',
        'singular_name'         => 'ISDG',
        'menu_name'             => 'Inverted SDGs',
        'name_admin_bar'        => 'ISDGs',
        'archives'              => 'ISDG Archives',
        'attributes'            => 'ISDG Attributes',
        'parent_item_colon'     => 'Parent ISDG',
        'all_items'             => 'All ISDGs',
        'add_new_item'          => 'Add New ISDGs',
        'add_new'               => 'Add New',
        'new_item'              => 'New ISDGs',
        'edit_item'             => 'Edit ISDG',
        'update_item'           => 'Update ISDG',
        'view_item'             => 'View ISDG',
        'view_items'            => 'View ISDGs',
        'search_items'          => 'Search ISDGs',
        'not_found'             => 'Not found',
        'not_found_in_trash'    => 'Not found in Trash',
        'featured_image'        => 'Featured Image',
        'set_featured_image'    => 'Set featured image',
        'remove_featured_image' => 'Remove featured image',
        'use_featured_image'    => 'Use as featured image',
        'insert_into_item'      => 'Insert into ISDG',
        'uploaded_to_this_item' => 'Uploaded to this ISDG',
        'items_list'            => 'ISDGs list',
        'items_list_navigation' => 'ISDGs list navigation',
        'filter_items_list'     => 'Filter ISDGs list',
    );
    $args = array(
        'label'                 => 'ISDG',
        'description'           => 'ISDGs',
    ...
    register_post_type( 'inverted_sdgs', $args );
}
add_action( 'init', 'custom_post_type_inverted_sdgs', 0 );